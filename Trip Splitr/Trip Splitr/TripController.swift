...
class TripController {
    ...
    var allTrips: [Trip] = [Trip(name: "Germany", date: "10/16/18", participants: [], baseCost: 0, img: "https://www.topuniversities.com/sites/default/files/articles/lead-images/germany-view.jpg", expenses: [], paidBy: "", complete: true),Trip(name: "Iceland", date: "5/1/19", participants: [Participant(name: "Kanye West", img: "https://static.independent.co.uk/s3fs-public/thumbnails/image/2018/04/26/12/cost-reuse-kanye-west-maga.jpg", spent: 0, used: 0 ), Participant(name: "Barack Obama", img: "https://res.cloudinary.com/fen-learning/image/upload/c_limit/infopls_images/images/barack-obama.gif", spent: 0, used: 0), Participant(name: "Donald Trump", img: "https://upload.wikimedia.org/wikipedia/commons/5/56/Donald_Trump_official_portrait.jpg", spent: 0, used: 0)], baseCost: 0, img: "https://www.telegraph.co.uk/content/dam/Travel/2019/March/Kirkjufell-iStock-959966730.jpg?imwidth=1400", expenses: [], paidBy: "", complete: false)]
